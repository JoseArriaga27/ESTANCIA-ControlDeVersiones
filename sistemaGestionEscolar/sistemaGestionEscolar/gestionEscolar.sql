...
("1","ADM001","Sandra","León","Martínez","Femenino","1980-02-11","sandra.leon@upemor.edu.mx","$2y$10$VP7EKDrh1PR2GEFxFdzeqex0QfTnYS3jVZaKmeYUZ4aLM.7Q/zW0W","Administrador","1"),
("2","ADM002","Roberto Enrique","Lopez","Díaz","Masculino","1978-06-22","roberto.cortes@upemor.edu.mx","admin2025","Administrador","1"),
...
CREATE TABLE reportes (
  ...
  CONSTRAINT reportes_ibfk_1 FOREIGN KEY (generadoPor)
    REFERENCES usuarios (idUsuario)
    ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- (Sin inserts definidos)
...
CREATE TABLE respaldos (
  ...
  KEY generadoPor (generadoPor),
  CONSTRAINT respaldos_ibfk_1 FOREIGN KEY (generadoPor)
    REFERENCES usuarios (idUsuario)
    ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
