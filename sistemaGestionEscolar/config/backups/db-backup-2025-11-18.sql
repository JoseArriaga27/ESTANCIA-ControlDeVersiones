...
CREATE TABLE `reportes` (
  ...
  CONSTRAINT `reportes_ibfk_1` FOREIGN KEY (`generadoPor`) REFERENCES `usuarios` (`idUsuario`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `respaldos` (
  ...
  KEY `generadoPor` (`generadoPor`),
  CONSTRAINT `respaldos_ibfk_1` FOREIGN KEY (`generadoPor`) REFERENCES `usuarios` (`idUsuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO usuarios VALUES("1","ADM001","Sandra","León","Martínez","Femenino","1980-02-11","sandra.leon@upemor.edu.mx","$2y$10$VP7EKDrh1PR2GEFxFdzeqex0QfTnYS3jVZaKmeYUZ4aLM.7Q/zW0W","Administrador","1");
INSERT INTO usuarios VALUES("2","ADM002","Roberto Enrique","Lopez","Díaz","Masculino","1978-06-22","roberto.cortes@upemor.edu.mx","admin2025","Administrador","1");
...
INSERT INTO usuarios VALUES("4","ADMT002","Elena","Torres","Soto","Femenino","1989-11-03","elena.torres@upemor.edu.mx","admin02","Administrativo","1");
...
INSERT INTO usuarios VALUES("17","DOC011","Camila","Solórzano","Velázquez","Femenino","1991-06-14","camila.solorzano@upemor.edu.mx","camila01","Docente","1");
...
INSERT INTO usuarios VALUES("44","ALU027","Brandon","Campos","Valdez","Masculino","2003-09-09","brandon.campos@upemor.edu.mx","pass27","Alumno","1");
