...
<div class="container mt-4 mb-5">
  <h3 class="text-center mb-4 fw-semibold">Gestión de Grupos</h3>
    ...
    <div class="card-body">
      <form method="POST" action="../controllers/grupoController.php" class="row g-3">
        ...
        <div class="col-md-3">
          ...
          <input type="text" name="nombreGrupo" class="form-control" placeholder="Ej. TI7A"
          ...
          <?php while ($g = $grupos->fetch_assoc()): ?>
            <tr>
              ...
              <td>
                ...
                <a href="../controllers/grupoController.php?delete=<?= $g['idGrupo'] ?>" class="btn btn-danger btn-sm"
